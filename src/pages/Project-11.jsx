...
const PortfolioPage11 = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-['Inter'] text-gray-900 antialiased">
      <title>Scandinavian Retreat Finland Residential | Halftone LLC Archviz</title>
      <meta name="description" content="Photorealistic 3D renders of a minimalist Scandinavian private residence in Finland, showcasing natural light and organic materials. Visualization by Halftone LLC." />
