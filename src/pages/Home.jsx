    ...
    <div className="min-h-screen bg-white font-['Inter'] text-gray-900 antialiased">
      ...
      <header className="relative h-[80vh] flex flex-col items-center justify-start pt-12 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="https://placehold.co/1200x800/222222/eeeeee?text=Forest+Architecture+Hero"
            alt="Hero Background"
      ...
      {/* 5. Bottom Content Grid (Simulating the final three rows of images) */}
      <section className="px-4 sm:px-12 pt-16 pb-20">
        <div className="grid grid-cols-2 gap-4 sm:gap-6">
          {/* Final three rows from the image (simulated as two groups) */}
          <div className="col-span-2 md:col-span-1">
            <ImagePlaceholder ratioClass="400x600" text="Residential Tower" />
          </div>
          <div className="col-span-2 md:col-span-1 grid grid-cols-2 gap-4">
            <div className="col-span-1">
              <ImagePlaceholder ratioClass="400x400" text="Interior Detail 1" />
            </div>
            <div className="col-span-1">
              <ImagePlaceholder ratioClass="400x400" text="Interior Detail 2" />
            </div>
            <div className="col-span-2">
              <ImagePlaceholder ratioClass="800x400" text="Window Frames" />
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-stone-100 pt-16 pb-24">
        <div className="container mx-auto max-w-4xl px-6">
          <DecorativeHeader title="ÖRÖMÜK" />

          <p className="text-center text-xs text-gray-500 max-w-2xl mx-auto mb-12">
            Halftone LLC, 123 Architecture Lane, Building A, New York, NY 10001
          </p>
          ...
          <div className="flex justify-center border-t border-b border-gray-300 divide-x divide-gray-300 max-w-lg mx-auto">
            {footerLinks.map((item, index) => (
              <div
                key={index}
                className="flex-1 text-center py-4 group cursor-pointer hover:bg-stone-200 transition duration-150"
              >
          ...
          <p className="text-center text-xs text-gray-400 mt-12">
            © 2024 HALFTONE LLC. ALL RIGHTS RESERVED.
          </p>
        </div>
      </footer>
    </div>
